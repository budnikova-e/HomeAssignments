...
std::string Decepticon::getAltMode() { return _altMode; }
int Decepticon::getTerrorFactor() { return _terrorFactor; }

void Decepticon::setAltMode(std::string mode) { _altMode = mode; }
void Decepticon::setTerrorFactor(int factor) { _terrorFactor = factor; }
